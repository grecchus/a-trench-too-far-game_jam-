...
/** @type {string} */
const CACHE_VERSION = '1774294322|621819163';
/** @type {string} */
const CACHE_PREFIX = 'A Trench Too Far-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'A Trench Too Far.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["A Trench Too Far.html","A Trench Too Far.js","A Trench Too Far.offline.html","A Trench Too Far.icon.png","A Trench Too Far.apple-touch-icon.png","A Trench Too Far.audio.worklet.js","A Trench Too Far.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["A Trench Too Far.wasm","A Trench Too Far.pck"];
